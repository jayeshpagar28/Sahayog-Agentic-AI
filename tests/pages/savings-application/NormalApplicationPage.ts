...
export class NormalApplicationPage {
  readonly page: Page;
  ...
  async startNewApplication(): Promise<void> {
    ...
    await this.page.locator('.col-xl-5.buttons-column button.btn', { hasText: 'Normal Savings Account - 1001' }).click();
  ...
  async verifyHeaderLoaded(): Promise<void> {
    ...
    await expect(this.schemeName).toContainText('Normal Savings Account - 1001');
  }
