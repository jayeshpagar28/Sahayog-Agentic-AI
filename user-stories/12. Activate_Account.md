...
1. Module Overview
The Activate Account module enables newly registered users to activate their SAHAYOG portal account before accessing the application. During activation, users are required to validate their identity using a Reference ID, User ID, Full Name, Date of Birth, Employee ID, and Registered Mobile Number.
...
As a user,
I want to provide my Reference ID, User ID, Full Name, Date of Birth, Employee ID, and Mobile Number,
...
Mobile Number and Employee ID are correctly mapped to the user. 
...
AA_FR_012
The Full Name field shall be mandatory.

AA_FR_013
The entered Full Name shall exactly match the registered user details.
...
AA_FR_016
The Employee ID field shall be mandatory.

AA_FR_017
The Employee ID shall match the registered employee record.

AA_FR_018
The Mobile Number field shall be mandatory.

AA_FR_019
The Mobile Number shall match the registered mobile number.

AA_FR_020
The Mobile Number shall be validated according to the configured mobile number format.
...
AA_BR_006
Full Name shall match the registered user information.

AA_BR_007
Date of Birth shall match the registered information.

AA_BR_008
Employee ID shall match the registered employee details.

AA_BR_009
Mobile Number shall match the registered mobile number.
...
AA_VR_010
Entered Full Name shall match the registered record.

AA_VR_011
Entered Date of Birth shall match the registered record.

AA_VR_012
Entered Employee ID shall match the registered record.

AA_VR_013
Mobile Number shall contain only valid numeric characters according to configured rules.
...
Full Name	Yes	Matches registered record
Date of Birth	Yes	Matches registered record
Employee ID	Yes	Matches employee record
Mobile Number	Yes	Valid registered mobile number
...
Valid Full Name	Name matching registration records
Invalid Full Name	Name not matching records
Valid Date of Birth	Registered DOB
Invalid Date of Birth	Incorrect DOB
Valid Employee ID	Registered employee ID
Invalid Employee ID	Incorrect employee ID
Valid Mobile Number	Registered mobile number
Invalid Mobile Number	Incorrect or invalid format
